...
export default function FormativeGradesManagement({ user, onNavigate }: { user: any, onNavigate?: (menu: string) => void }) {
  ...
  const selectedType = 'FORMATIVE' // Hardcoded for Formative Assessment page
